    ...
    return (
        <div className='pt-20'>
            ...
            <div className='text-3xl flex justify-center mb-5 mt-5 text-green-600'>
                 <h1>Comments based on selected posts</h1>
            </div>
            }
            ...
            <div>
                {
                    data?.map(d =>
                        <div className='flex justify-center'>
                            <div className='border w-1/2 p-3 mb-3 shadow-2xl'>
                                <div className='flex items-center'>
                                    {d?.img ? <img src={d.img} alt="" className='rounded h-10' /> : <FaUserCircle className='text-3xl'></FaUserCircle>}
